public class Main {
    ...
    public static void task2(int typeOs, int clientDeviceYear) {
        if (clientDeviceYear <= 2015 && typeOs == 0) {
            System.out.println("Установите облегченную версию приложения для iOS по ссылке");
        } else if (clientDeviceYear >= 2015 && typeOs == 0) {
            System.out.println("Установите версию приложения для iOS по ссылке");
        } else if (clientDeviceYear <= 2015 && typeOs == 1) {
